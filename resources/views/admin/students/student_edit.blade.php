...
@section('content')
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit Student<small></small></h2>
                  ...
                  <div class="x_content">
                    <br />
                      ...
                      <form method="post" action="{{ route('admin.students.update', ['id' => $students->id]) }}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="form-group{{ $errors->has('lrn_or_id_no') ? ' has-error' : '' }}">
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" value="{{$students->personal_information->lrn_or_id_no}}"  name="lrn_or_id_no" id="lrn_or_id_no" class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group{{ $errors->has('lastname') ? ' has-error' : '' }}">
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" value="{{$students->personal_information->lastname}}" name="lastname" id="lastname" class="form-control col-md-7 col-xs-12">
                               ...
                               <div class="form-group{{ $errors->has('firstname') ? ' has-error' : '' }}">
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" value="{{$students->personal_information->firstname}}" name="firstname" id="firstname" class="form-control col-md-7 col-xs-12">
                              ...
                              <!-- Middlename -->
                               <div class="form-group">
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" value="{{$students->personal_information->middlename}}" name="middlename" id="middlename" class="form-control col-md-7 col-xs-12">  
                                  </div>
                                </div>
                             ...
                             <!--Suffix-->
                              <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" value="{{$students->personal_information->suffix}}" name="suffix" id="suffix" class="form-control col-md-7 col-xs-12">
                                </div>
                              </div>
                              ...
                              <div class="form-group{{ $errors->has('date_of_birth') ? ' has-error' : '' }}">
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" value="{{$students->personal_information->date_of_birth}}" name="date_of_birth" id="date_of_birth" class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12" style="margin-top:10px;">
                                    <p>
                                     @if($students->personal_information->gender=="Male")
                                     ...
                                     @else
                                            M:<input type="radio" class="flat" name="gender" id="genderM" value="Male" /> 
                                            F:<input type="radio" class="flat" name="gender" id="genderF" value="Female" checked="checked" required />
                                     @endif
                                    </p>
                                  </div>
                                </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" value="{{$students->personal_information->address}}" name="address" id="address" class="form-control col-md-7 col-xs-12">
                                </div>
                              </div>
                               ...
                               <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" value="{{$students->personal_information->contact_no}}" name="contact_no" id="contact_no" class="form-control col-md-7 col-xs-12">
                                </div>
                              </div>
                              ...
                              <!-- School Year -->
                              <input type="hidden" name="school_year" value="{{$students->school_year}}">

                              <!-- Semester -->
                              <input type="hidden" name="semester" value="{{$students->semester}}">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="track_and_strand" id="track_and_strand" class="form-control">
                                  <option value="{{$students->strand->id}}">&nbsp;&nbsp;{{$students->strand->abbreviation}}</option>
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="grade_level" id="grade_level" class="form-control">
                                  <option value="{{$students->grade_level}}">{{$students->grade_level}}</option>
